...
public class ExtendedTestServer extends AbstractTestServer {
	...
	public static void main(String[] args) {
		...
		org.eclipse.californium.elements.MyLogger.LOG_error("start!");
	...
	private static void printManagamentStatistic() {
		...
		org.eclipse.californium.elements.MyLogger.LOG_info("{} processors", processors);
		...
		if (threadMxBean.isThreadCpuTimeSupported() && threadMxBean.isThreadCpuTimeEnabled()) {
			...
			org.eclipse.californium.elements.MyLogger.LOG_info("cpu-time: {} ms (per-processor: {} ms)",
