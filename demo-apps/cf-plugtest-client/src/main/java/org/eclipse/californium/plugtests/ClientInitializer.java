...
public class ClientInitializer {
	...
	public static Arguments init(NetworkConfig config, String[] args, boolean ephemeralPort) throws IOException {
		...
		coapEndpoint.start();
		org.eclipse.californium.core.MyLogger.LOG_info("endpoint started at {}", coapEndpoint.getAddress());
...
//		Connector connector = null;
	...
	public static class PlugPskStore extends StringPskStore {
		...
		public PlugPskStore(String id, byte[] secret) {
			...
			org.eclipse.californium.core.MyLogger.LOG_trace("DTLS-PSK-Identity: {}", identity);
		}

		public PlugPskStore(String id) {
			identity = PSK_IDENTITY_PREFIX + id;
			secret = null;
			org.eclipse.californium.core.MyLogger.LOG_trace("DTLS-PSK-Identity: {} ({} random bytes)", identity, (id.length() / 2));
		}
