...
public class OSCoreBlockwiseTransferTest {
	@ClassRule
	...
	@BeforeClass
	public static void prepare() throws OSException {
	...
	private void executeGETRequest(final boolean respondShort, final boolean cancelRequest, final boolean m) throws Exception {
		...
		db.addContext(getUri(serverEndpoint, RESOURCE_TEST), ctx);
	...
	private static CoapServer createSimpleServer() throws OSException {

		OSCoreCtx ctx2 = new OSCoreCtx(master_secret, true, alg, rid, sid, kdf, 32, master_salt, null);
		db.addContext("coap://localhost", ctx2);
