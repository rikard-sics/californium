 ...
 *
 */
public class HelloWorldServerInitialize {
	...
	public static void main(String[] args) throws OSException {
		String CIPHER_NAME = "AES/ECB/NoPadding";
		ThreadLocalCipher CIPHER = new ThreadLocalCipher(CIPHER_NAME);
		Cipher test = CIPHER.current();
		...
		CoapResource hello1 = new CoapResource("1", true) {
			...
			public void handleGET(CoapExchange exchange) {
				...
				System.out.println("Accessing hello/1 resource (using OSCORE: " + usingOscore + ")");
				Response r = new Response(ResponseCode.CONTENT);
