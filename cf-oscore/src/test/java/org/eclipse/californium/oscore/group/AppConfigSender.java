...
public class AppConfigSender {

	private static Properties props = new Properties();

	private static final String configFilename = "sender_config.properties";
	...
	public static AlgorithmID getAlg(String key) {
		try {
			return AlgorithmID.FromCBOR(CBORObject.FromObject(AppConfigSender.getInt(key)));
