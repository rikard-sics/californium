...
import org.eclipse.californium.oscore.group.GroupKeyDerivationInteropTest;
...
@SuiteClasses({ ByteIdTest.class, HashMapCtxDBTest.class, OptionJuggleTest.class, OSCoreCtxTest.class, OSCoreTest.class,
		...
		GroupModesTestAlt.class, GroupKeyDerivationTest.class, GroupKeyDerivationInteropTest.class,
