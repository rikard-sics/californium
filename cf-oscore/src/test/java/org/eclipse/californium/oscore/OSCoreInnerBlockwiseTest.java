 ...
 *
 * Also tests the MAX_UNFRAGMENTED_SIZE parameter to ensure that messages
...
public class OSCoreInnerBlockwiseTest {
	...
	/**
	 * Perform a PUT request that is not sent block-wise even though it is
	 * exceeding the configured MAX_UNFRAGMENTED_SIZE parameter. This means that
