...
public class MemoryLeakingHashMapTest {
	...
	public void testSimpleNONGet() throws Exception {
		...
		org.eclipse.californium.core.MyLogger.LOG_debug("Test simple NON GET to {}", uri);
		...
		org.eclipse.californium.core.MyLogger.LOG_debug("Client received response [{}] with msg type [{}]", new Object[]{response.getPayloadString(), response.getType()});
	...
	private static void testSimpleGet(final Mode mode) throws Exception {
		...
		String uri = uriOf(URI);
		org.eclipse.californium.core.MyLogger.LOG_debug("Test simple GET to {}", uri);
	...
	private static void testBlockwise(final CoapClient client, final Mode mode) throws ConnectorException, IOException {
		...
		org.eclipse.californium.core.MyLogger.LOG_debug("Test blockwise POST to {}", client.getURI());
	...
	private static void assertThatResponseContainsValue(CoapResponse response, String expectedValue) {
		...
		org.eclipse.californium.core.MyLogger.LOG_debug("Client received response [{}]", response.getResponseText());
	...
	public void testObserveProactive() throws Exception {
		org.eclipse.californium.core.MyLogger.LOG_debug("Test observe relation with a proactive cancelation");
	...
	public void testObserveProactiveBlockwise() throws Exception {
		org.eclipse.californium.core.MyLogger.LOG_debug("Test observe relation with blockwise notifications and proactive cancelation");
	...
	private static class TestResource extends CoapResource {
		...
		public void handlePOST(final CoapExchange exchange) {
			...
			org.eclipse.californium.core.MyLogger.LOG_debug("TestResource [{}] received POST message: {}", new Object[]{getName(), exchange.getRequestText()});
	...
	private class CoapObserverAndCanceler extends CountingCoapHandler {
		...
		public void assertLoad(CoapResponse response) {
			...
			if (null == relation) {
				org.eclipse.californium.core.MyLogger.LOG_info("Client ignore notification {}: [{}]", counter, response.getResponseText());
				return;
			}

			org.eclipse.californium.core.MyLogger.LOG_debug("Client received notification {}: [{}]", counter, response.getResponseText());

			if (cancelProactively) {
				if ((counter + 1) == expectedNotifies) {
					org.eclipse.californium.core.MyLogger.LOG_debug("Client proactively cancels observe relation");
					relation.proactiveCancel();
				}
			} else {
				if (counter == expectedNotifies) {
					org.eclipse.californium.core.MyLogger.LOG_debug("Client forgets observe relation");
