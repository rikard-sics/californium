...
public class CountingCoapHandler implements CoapHandler {
	...
	public final void onLoad(CoapResponse response) {
		...
		synchronized (this) {
			...
			try {
				...
				org.eclipse.californium.elements.MyLogger.LOG_error("Assert:", error);
				this.exception = error;
			} catch (RuntimeException exception) {
				org.eclipse.californium.elements.MyLogger.LOG_error("Unexpected error:", exception);
				this.exception = exception;
			}
			notifyAll();
		}
		org.eclipse.californium.elements.MyLogger.LOG_info("Received {}. Notification: {}", counter, response.advanced());
	}
	...
	public final void onError() {
		...
		org.eclipse.californium.elements.MyLogger.LOG_info("{} Errors!", counter);
	}
