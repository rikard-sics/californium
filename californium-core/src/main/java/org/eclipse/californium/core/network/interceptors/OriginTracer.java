...
public final class OriginTracer extends MessageInterceptorAdapter {
	...
	public void receiveRequest(Request request) {
		org.eclipse.californium.elements.MyLogger.LOG_trace("{}", request.getSourceContext().getPeerAddress());
	}
	...
	public void receiveEmptyMessage(EmptyMessage message) {
		...
		if (message.getType() == Type.CON) {
			org.eclipse.californium.elements.MyLogger.LOG_trace("{}", message.getSourceContext().getPeerAddress());
		}
	}
}
