...
public abstract class BaseCoapStack implements CoapStack {
	...
	public void sendRequest(final Exchange exchange, final Request request) {
		...
		try {
			...
			org.eclipse.californium.core.MyLogger.LOG_warn("error send request {}", request, ex);
	...
	public void sendResponse(final Exchange exchange, final Response response) {
		...
		try {
			...
			org.eclipse.californium.core.MyLogger.LOG_warn("error send response {}", response, ex);
	...
	public void sendEmptyMessage(final Exchange exchange, final EmptyMessage message) {
		...
		try {
			...
			org.eclipse.californium.core.MyLogger.LOG_warn("error send empty message {}", message, ex);
	...
	private class StackTopAdapter extends AbstractLayer {
		...
		public void receiveRequest(final Exchange exchange, final Request request) {
			...
			if (hasDeliverer()) {
				...
				org.eclipse.californium.core.MyLogger.LOG_error("Top of CoAP stack has no deliverer to deliver request");
			}
		}
		...
		public void receiveResponse(final Exchange exchange, final Response response) {
			if (hasDeliverer()) {
				...
				org.eclipse.californium.core.MyLogger.LOG_error("Top of CoAP stack has no deliverer to deliver response");
			}
		}
