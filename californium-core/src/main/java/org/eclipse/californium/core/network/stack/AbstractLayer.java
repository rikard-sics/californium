...
public abstract class AbstractLayer implements Layer {
	...
	public static final class LogOnlyLayer implements Layer {
		...
		@Override
		public void sendRequest(final Exchange exchange, final Request request) {
			org.eclipse.californium.core.MyLogger.LOG_error("No lower layer set for sending request [{}]", request);
		}

		@Override
		public void sendResponse(final Exchange exchange, final Response response) {
			org.eclipse.californium.core.MyLogger.LOG_error("No lower layer set for sending response [{}]", response);
		}

		@Override
		public void sendEmptyMessage(Exchange exchange, EmptyMessage emptyMessage) {
			org.eclipse.californium.core.MyLogger.LOG_error("No lower layer set for sending empty message [{}]", emptyMessage);
		}

		@Override
		public void receiveRequest(final Exchange exchange, final Request request) {
			org.eclipse.californium.core.MyLogger.LOG_error("No upper layer set for receiving request [{}]", request);
		}

		@Override
		public void receiveResponse(final Exchange exchange, final Response response) {
			org.eclipse.californium.core.MyLogger.LOG_error("No lower layer set for receiving response [{}]", response);
		}

		@Override
		public void receiveEmptyMessage(final Exchange exchange, final EmptyMessage emptyMessage) {
			org.eclipse.californium.core.MyLogger.LOG_error("No lower layer set for receiving empty message [{}]", emptyMessage);
		}
