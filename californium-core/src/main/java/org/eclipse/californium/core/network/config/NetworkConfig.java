...
public final class NetworkConfig {
	...
	public static NetworkConfig createStandardWithoutFile() {
		org.eclipse.californium.elements.MyLogger.LOG_info("Creating standard network configuration properties without a file");
	...
	public static NetworkConfig createFromStream(InputStream inStream,
		...
		org.eclipse.californium.elements.MyLogger.LOG_info("Creating network configuration properties from stream");
		...
		try {
			...
			org.eclipse.californium.elements.MyLogger.LOG_warn("cannot load properties from stream: {}", e.getMessage());
		}
		return standard;
	}
	...
	public void load(final File file) {
		if (file == null) {
			...
			org.eclipse.californium.elements.MyLogger.LOG_info("loading properties from file {}", file.getAbsolutePath());
			try (InputStream inStream = new FileInputStream(file)) {
				load(inStream);
			} catch (IOException e) {
				org.eclipse.californium.elements.MyLogger.LOG_warn("cannot load properties from file {}: {}",
	...
	public void store(File file, String header) {
		if (file == null) {
			...
			org.eclipse.californium.elements.MyLogger.LOG_info("writing properties to file {}", file.getAbsolutePath());
			try (FileWriter writer = new FileWriter(file)) {
				properties.store(writer, header);
			} catch (IOException e) {
				org.eclipse.californium.elements.MyLogger.LOG_warn("cannot write properties to file {}: {}",
						new Object[] { file.getAbsolutePath(), e.getMessage() });
			}
		}
	}
	...
	private <T> T getNumberValue(final PropertyParser<T> parser, final String key, final T defaultValue) {
		...
		if (value != null && !value.isEmpty()) {
			try {
				...
				org.eclipse.californium.elements.MyLogger.LOG_warn("value for key [{}] is not a {0}, returning default value", key, defaultValue.getClass());
			}
		} else if (value == null) {
			org.eclipse.californium.elements.MyLogger.LOG_warn("key [{}] is undefined, returning default value", key);
		} else {
			org.eclipse.californium.elements.MyLogger.LOG_warn("key [{}] is empty, returning default value", key);
		}
		return result;
	}
	...
	public boolean getBoolean(final String key, final boolean defaultValue) {
		...
		if (value != null) {
			...
			org.eclipse.californium.elements.MyLogger.LOG_warn("Key [{}] is undefined, returning defaultValue", key);
			return defaultValue;
		}
	}
	...
	public boolean getBoolean(String key) {
		...
		if (value != null) {
			...
			org.eclipse.californium.elements.MyLogger.LOG_warn("Key [{}] is undefined", key);
			return false;
		}
	}
