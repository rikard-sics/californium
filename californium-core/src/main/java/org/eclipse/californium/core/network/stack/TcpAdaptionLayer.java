...
public class TcpAdaptionLayer extends AbstractLayer {
	...
	public void sendEmptyMessage(final Exchange exchange, final EmptyMessage message) {
		...
		if (message.isConfirmable()) {
			...
			org.eclipse.californium.core.MyLogger.LOG_warn("attempting to send empty message (ACK/RST) in TCP mode {} - {}", message, exchange.getCurrentRequest(), new Throwable());
		}
	}
	...
	public void receiveEmptyMessage(Exchange exchange, EmptyMessage message) {
		...
		org.eclipse.californium.core.MyLogger.LOG_info("discarding empty message received in TCP mode: {}", message);
	}
