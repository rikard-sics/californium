	...
	protected void complete(final String action) {
		if (exchange.executeComplete()) {
			if (exchange.isOfLocalOrigin()) {
				...
				org.eclipse.californium.elements.MyLogger.LOG_debug("{}, {} request [MID={}, {}]", action, exchange, request.getMID(), request.getToken());
			} else {
				Response response = exchange.getCurrentResponse();
				org.eclipse.californium.elements.MyLogger.LOG_debug("{}, {} response [MID={}, {}]", action, exchange, response.getMID(), response.getToken());
			}
		}
	}
}
