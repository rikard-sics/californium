...
public class Phase3Client {
	...
	public static void main(String args[]) throws ConnectorException, IOException, InterruptedException {
		...
		org.eclipse.californium.core.network.serialization.DataParser.setPhase("Client3");
		org.eclipse.californium.core.network.serialization.UdpDataSerializer.setPhase("Client3");
	...
	private static void edhocExchangeAsInitiator(final String args[], final URI targetUri, Set<CBORObject> ownIdCreds,
        ...
        */		
		        ...
		        try {
		        	...
		        	if (OSCORE_EDHOC_COMBINED == true && requestType == Constants.EDHOC_MESSAGE_3 &&
						...
						if (myPayload != null) {
							...
							System.out.println(
									"Time elapsed for EDHOC & 1st OSCORE response: " + (timeTotal / 1000000) + " ms");
		...
		try (FileWriter fw = new FileWriter("output-edhoc.txt", true);
			...
			out.println("Client3: " + "Time elapsed for EDHOC & 1st OSCORE response: "
