...
public class Phase2Server extends CoapServer {
	...
	public static void main(String[] args) {
		...
		// System.out.println("Started Phase 2 server");
		...
		try {
			...
			Phase2Server server = new Phase2Server();
	 ...
	 */
	public Phase2Server() throws SocketException {
		...
		case Constants.CRED_TYPE_CCS:				
			...
			if (peerKeyCurve == KeyKeys.EC2_P256.AsInt32()) {
				peerCred = net.i2p.crypto.eddsa.Utils.hexToBytes("a2026008a101a501020241242001215820cd4177ba62433375ede279b5e18e8b91bc3ed8f1e174474a26fc0edb44ea5373225820a0391de29c5c5badda610d4e301eaaa18422367722289cd18cbe6624e89b9cfd");
	 			...
	 			peerCred = net.i2p.crypto.eddsa.Utils.hexToBytes("A2026008A101A401010205200621582038E5D54563C2B6A4BA26F3015F61BB706E5C2EFDB556D2E1690B97FC3C6DE149");
	 		}
	 		else if (peerKeyCurve == KeyKeys.OKP_X25519.AsInt32()) {
	 			...
	 			peerCred = net.i2p.crypto.eddsa.Utils.hexToBytes("A2026008A101A40101020520042158202C440CC121F8D7F24C3B0E41AEDAFE9CAA4F4E7ABB835EC30F1DE88ADB96FF71");
	 		}
			break;
		case Constants.CRED_TYPE_X509:
