...
public class Phase3Server extends CoapServer {
	...
	public static void main(String[] args) {
		...
		// System.out.println("Started Phase 3 server");
		...
		try {
			...
			Phase3Server server = new Phase3Server();
	 ...
	 */
	public Phase3Server() throws SocketException {
